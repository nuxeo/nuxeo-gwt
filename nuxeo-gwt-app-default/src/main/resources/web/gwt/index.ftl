...
<html>
  <head>
    ...
    <script laguage="javascript">
      var isomorphicDir = "${skinPath}/resources/org.nuxeo.ecm.gwt.app.base.Default/js/sc/";
  ...
  <body>
    ...
    <div id="loadingWrapper">
      <div id="loading">
        <div class="loadingIndicator">
           ...
           <img src="${skinPath}/resources/org.nuxeo.ecm.gwt.app.base.Default/images/loading_app.gif" width="32" height="32" hspace="2"/>
              </td><td align="left">
    ...
    <!--                                           -->
    <script type="text/javascript" language="javascript" src="${skinPath}/resources/org.nuxeo.ecm.gwt.app.base.Default/org.nuxeo.ecm.gwt.app.base.Default.nocache.js"></script>
