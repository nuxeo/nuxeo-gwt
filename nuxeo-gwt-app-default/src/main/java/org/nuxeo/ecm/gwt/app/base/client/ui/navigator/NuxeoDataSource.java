...
package org.nuxeo.ecm.gwt.app.base.client.ui.navigator;

import org.nuxeo.ecm.gwt.app.base.client.ui.login.LoginDialog;
...
public class NuxeoDataSource extends RestDataSource {
    ...
    $wnd.isc.DataSource.addMethods({
       ...
       return @org.nuxeo.ecm.gwt.app.base.client.ui.navigator.NuxeoDataSource::handleError(Lcom/smartgwt/client/data/DSResponse;Lcom/smartgwt/client/data/DSRequest;)(responseJ, requestJ);
       }
    });
    }-*/;
