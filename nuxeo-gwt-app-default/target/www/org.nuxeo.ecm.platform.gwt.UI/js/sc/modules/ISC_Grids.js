...
,isc.A.output_value=function(_1,_2,_3){var _4;if(this.showLabel){_4="<TD WIDTH=10% CLASS='"+this.labelStyle+"' ALIGN=RIGHT"+(this.wrapLabel?">":" NOWRAP><NOBR>")+this.labelPrefix+(_2.title?_2.title:_2[this.fieldIdProperty])+this.labelSuffix+"<\/NOBR><\/TD>"}else{_4=""}
if(_2.valueMap&&isc.isA.String(_2.valueMap))
_2.valueMap=this.getGlobalReference(_2.valueMap);for(var i=0;i<_3.getLength();i++){var _6;if(_2.type=="image"){var _7,_8,_9,_10,_11;var _12=_3.get(i);if(isc.isA.String(_2.imageWidth)){_9=_2.imageWidth}else{_7=_2.imageWidth}
...
if(_12!=null){_7=_7||_12[_9]||_12[_11];_8=_8||_12[_10]||_12[_11]}
var _13=this.getCellValue(_3.get(i),_2),_14=_2.imageURLPrefix||_2.baseURL||_2.imgDir;_6=this.imgHTML(_13,_7,_8,null,_2.extraStuff,_14,_2.activeAreaHTML)}else{_6=this.getCellValue(_3.get(i),_2)}
var _15;if(_2.getCellStyle)_15=_2.getCellStyle(_6,_2,_12,this);else _15=(this.getCellStyle(_6,_2,_12,this)||this.cellStyle);var _16=" style='";if(this.clipValues)_16+="overflow:hidden;";_16+="text-align:"+this.valueAlign;_16+="'";_4+="<TD CLASS='"+_15+"'"+_16+(this.wrapValues?">":" NOWRAP><NOBR>")+_6+(this.wrapValues?"<\/NOBR>":"")+"<\/TD>"}
return _4}
,isc.A.getCellStyle=function(_1,_2,_3,_4){return _2.cellStyle}
...
,isc.A.getEmptyMessageHTML=function(){if(!this.showEmptyMessage)return"&nbsp;";if(this.isPrinting){return"<span class='"+this.emptyMessageTableStyle+"'>"+this.getEmptyMessage()+"</span>"}
var _1=this.getInnerWidth(),_2=0;if(this.expandEmptyMessageToMatchFields&&this.$26a){_2=this.$26a.sum()-_1;if(_2<0)_2=0}
var _3=_2&&this.overflow!=isc.Canvas.VISIBLE;var _4=isc.StringBuffer.create();_4.append("<TABLE BORDER=0 MARGIN=0 CELLSPACING=0 CLASS='",this.emptyMessageTableStyle,"' style='width:",(_1+_2),"px;",(isc.Browser.isSafari?"height"+this.getInnerHeight()+":px;'":"' HEIGHT=100%"),"><TR><TD ALIGN=CENTER VALIGN=TOP CLASS='",this.emptyMessageStyle,"' style='padding-left:0px;padding-right:0px;'>",this.getEmptyMessage(),(_2&&_3?"<br>"+isc.Canvas.spacerHTML(_1,1):null),"</TD>");if(_2&&_3){_4.append("<TD style='padding-left:0px;padding-right:0px;'>",isc.Canvas.spacerHTML(_2,1),"</TD>")}
_4.append("</TR></TABLE>");return _4.release()}
,isc.A.getEmptyMessage=function(){return this.emptyMessage}
,isc.A.getInnerHTML=function(){var _1=this.getTableHTML(),_2=this.$57k;_2[1]=this.getTableZIndex();_2[3]=_1;return _2.join(isc.emptyString)}
...
{_4+=1}
if(this.selectionEnabled()&&!this.isPrinting){var _6=(this.canSelectCells?this.selection.cellIsSelected(_2,_3):this.selection.isSelected(_1));if(_6)_4+=2}}
return _4}
...
return true}
);isc.evalBoundary;isc.B.push(isc.A.refreshCellStyle=function(_1,_2,_3){return this.setCellStyle(_1,_2,_3)}
...
_12=_15>_16;if(this.autoFitMaxHeight&&_17>this.autoFitMaxHeight){_17=this.autoFitMaxHeight;_12=true}
if(_17>_9)_9=_17;else{var _22=this.getScrollHeight();_12=(_22>=_9)}}}else{_12=this.getScrollHeight()>(this.$1g||this.getHeight())}
if(_8){var _23=this.getColumnSizes();var _24=_23.sum();if(this.autoFitMaxColumns&&this.autoFitMaxColumns<_23.length){_23=_23.slice(0,this.autoFitMaxColumns)}
var _25=_23.sum();if(this.autoFitMaxWidth)_25=Math.min(this.autoFitMaxWidth,_25);_10=Math.max(this.$1i,_25);_11=_24>_10}else{_11=this.getScrollWidth()>(this.$1i||this.getWidth())}
if(_9!=null&&_9!=this.$1g){_9+=this.getVBorderPad()+this.getVMarginSize();if(_11){_9+=this.getScrollbarSize();if(this.autoFitMaxHeight&&_9>this.autoFitMaxHeight){_9=this.autoFitMaxHeight}}}
...
_14=this.getDelta(this.$o5,_9,this.getHeight());_13=this.getDelta(this.$o6,_10,this.getWidth());if(_14!=null||_13!=null)this.resizeBy(_13,_14,null,null,true);if(_10!=null){var _26=this.parentElement,_27=_26.header;if(_27&&_27.isDrawn()){_27.setWidth(_10-(_12?_26.getScrollbarSize():0))}
if(_26.sorter&&_26.$313()&&!_26.isRTL()){_26.sorter.setLeft(_10-_26.getScrollbarSize());if(!_26.sorter.isVisible())_26.sorter.show()}else if(_26.sorter){_26.sorter.setLeft(0-_26.sorter.getWidth())}}}
...
,isc.A.$517=function(){var _1=this.grid,_2=_1.getEditForm(),_3=[],_4=_2.getItems();if(!_1.editByCell){var _5=_1.getEditRow(),_6=_1.getRecord(_5),_7=_1.getEditFormItemFieldWidths(_6);var _4=_2.getItems(),_8=_4.getProperty(this.fieldIdProperty),_9=_1.getDrawnFields(),_10=_9.getProperty(this.fieldIdProperty);var _11=_4.length==_9.length,_12=false;for(var i=0;i<_4.length;i++){var _14=_10.indexOf(_8[i]);if(_14==-1){_12=true;_3.add(_4[i])}else{_4[i].width=_7[_14];_4[i].redrawing()}}
if(!_11||_12){var _15=_1.getEditedRecord(_5,0);for(var i=0;i<_9.length;i++){if(!_8.contains(_10[i])){var _16=this.fields.indexOf(_9[i]);var _17=_1.getEditItem(_9[i],_6,_15,_5,_16,_7[_16]);_2.addItem(_17)}}}}
return _3}
...
return _2}
,isc.A.$29t=function(_1,_2,_3,_4){var _5=this.parentElement;if(_5&&_5.showSelectionCanvas)_5.updateSelectionCanvas();return this.invokeSuper(isc.GridBody,"$29t",_1,_2,_3,_4)}
...
,isc.A.setAutoFitMaxHeight=function(_1){this.autoFitMaxHeight=_1;if(this.body){this.body.autoFitMaxHeight=_1;this.body.adjustOverflow()}}
...
if(!this.booleanFalseImage&&!this.booleanTrueImage){this.booleanTrueImage=isc.CheckboxItem?isc.CheckboxItem.getInstanceProperty("checkedImage"):null;this.booeanFalseImage=isc.CheckboxItem?isc.CheckboxItem.getInstanceProperty("uncheckedImage"):null;this.booleanImageWidth=isc.CheckboxItem?isc.CheckboxItem.getInstanceProperty("valueIconWidth"):null;this.booleanImageHeight=isc.CheckboxItem?isc.CheckboxItem.getInstanceProperty("valueIconHeight"):null}
var _2=this.$60z(),_3=(_2!=null&&this.fields?this.fields[_2]:null);var _4=this.$30a,_5=this.getEditRow(),_6=this.getEditCol(),_7=this.$286,_8=this.fields?this.getEditFieldName():null;if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1);if(this.completeFields==null)this.completeFields=[];if(this.canRemoveRecords){var _9=this.completeFields.findIndex("isRemoveField",true),_10=(_9>=0)?this.completeFields[_9]:{isRemoveField:true};if(!_10.$61a){isc.addProperties(_10,this.removeFieldDefaults,this.removeFieldProperties);if(_10.name==null)_10.name="$61b";if(_10.cellIcon==null)_10.cellIcon=this.removeIcon;if(_9==-1){this.completeFields.add(_10)}
_10.$61a=true}}
if(isc.DataSource)this.$45n();if(this.fieldState!=null)this.setFieldState();this.applyFieldDefaults(this.completeFields);this.deriveVisibleFields();if(this.fields.length==0){var _11=this.completeFields.length>0;if(!_11){this.logWarn("This component has no specified fields. In order to display data "+"fields must be set up either via an explicit call to setFields() or "+"by binding to a dataSource.")}else{this.logWarn("All specified fields for this component are hidden. Note that fields "+"may be hidden via 'showIf' or 'detail' attribute values. "+"In order to display data this grid must have some visible fields.")}}
this.$26a=null;var _12,_13,_14;if(_4){this.storeUpdatedEditorValue();_12=this.fields.findIndex(this.fieldIdProperty,_8);if(_12!=-1&&!this.canEditCell(_5,_12))
_12=-1;if(_12==-1){var _15;if(!this.editByCell)_15=this.findNextEditCell(_5,0,1,true,true,false,true);if(_15!=null&&_15[0]==_5){_12=_15[1]}
if(_12==-1){this.cancelEditing(isc.ListGrid.PROGRAMMATIC);_4=false}}else{var _16=_7.getItem(_8);if(_16){_14=_16.hasFocus;if(_14)_7.$106()}
_13=true}
if(_4)this.hideInlineEditor(false,true)}
var _17=(this.canFreezeFields==null||this.$60v)&&this.fixedRecordHeights!=false&&this.fixedFieldWidths!=false&&this.autoFitData!="horizontal"&&this.autoFitData!="both"&&this.bodyOverflow!="visible";if(_17){if(this.completeFields.getProperty("overflow").contains("visible"))_17=false}
if(_17){this.$60v=true;this.canFreezeFields=true}else if(this.$60v){delete this.$60v;this.canFreezeFields=null}
if(this.canSelectCells)this.selection.numCols=this.fields.length;if(_3){var _18=this.fields.indexOf(_3);if(_18==-1)_18=null;this.$600(_18)}
if(this.showHeader&&this.headerHeight>0&&this.header!=null){this.updateHeader();if(this.body!=null)this.syncHeaderScrolling()}
this.updateBody();this.layoutChildren(this.$604);if(this.$52b!=null){var _19={};for(var i in this.$52b){if(this.$52b[i]==null)continue;var _21=this.$52b[i].$31x,_22=(this.dataSource!=null?this.getDataSource().getPrimaryKeyFieldNames():[]);for(var _23 in _21){if(!this.fields.containsProperty(this.fieldIdProperty,_23)&&!_22.contains(_23)){_19[_23]=true;this.clearEditValue(_21,_23,true)}}}
_19=isc.getKeys(_19);if(_19.length>0){this.logInfo("'setFields()' removed the following fields which had pending edit "+"values for some row[s]: '"+_19.join("', '")+"'.\n"+"Edit values for these fields have been dropped.","gridEdit")}}
if(_4){if(_13){this.showInlineEditor(_5,_12,false,false,true);if(_14)_7.$11b(_24)}else{this.$31u(_5,_12,!_14)}
if(_14){var _24=this.getEditFieldName();if(_24==_8){_7.$11b(_24)}else{_7.focusInItem(_24)}}}
if(this.$60z()!=null&&this.canSort)this.resort();if(this.hilites)this.setHilites(this.hilites);if(this.filterEditor!=null)this.filterEditor.setFields(this.completeFields.duplicate())}
...
if(!this.hilites||_1[this.hiliteProperty]==null)return _4;_4=this.$58a(_1,_3,_4);return _4}
...
return _6}
);isc.evalBoundary;isc.B.push(isc.A.getCellAlign=function(_1,_2,_3){if(_1&&(_1[this.singleCellValueProperty]!=null)){return isc.Canvas.LEFT}
...
,isc.A.setHilites=function(_1){this.hilites=_1;this.$58b=this.hilites.makeIndex("id");this.applyHilites()}
,isc.A.applyHilites=function(){var _1=this.hilites,_2=this.data;if(isc.isA.ResultSet(_2))_2=_2.getAllLoadedRows()
_2.setProperty(this.hiliteProperty,null);for(var i=0;i<_1.length;i++){this.applyHilite(_1[i],_2)}
this.markForRedraw()}
,isc.A.getHilite=function(_1){if(isc.isAn.Object(_1))return _1;return(this.$58b?this.$58b[_1]:null)}
,isc.A.applyHilite=function(_1,_2,_3){_1=this.getHilite(_1);if(!_1.criteria)return;var _3=_3||_1.fieldName;if(_3==null)_3=this.fields.getProperty("name");var _4=this.getDataSource().applyFilter(_2,_1.criteria);this.logWarn("applying filter: "+isc.Comm.serialize(_1.criteria)+", produced matches: "+isc.echoLeaf(_4));var _5=isc.isAn.Array(_3)?_3:[_3];for(var j=0;j<_5.length;j++){var _7=this.getField(_5[j]);for(var i=0;i<_4.length;i++){var _9=_4[i];this.hiliteRecord(_9,_7,_1)}}}
,isc.A.hiliteRecord=function(_1,_2,_3){var _4=_1[this.hiliteProperty];if(_4==null)_4=_1[this.hiliteProperty]=this.$578++;var _5=_2.$58c=_2.$58c||{},_6=_5[_4];if(_6==null)_5[_4]=_3.id;else _5[_4]=[_6,_3.id]}
,isc.A.$58a=function(_1,_2,_3){var _4=_1[this.hiliteProperty],_5=this.getField(_2);if(!_5.$58c)return;var _6=_5.$58c[_4];if(_6==null)return;if(!isc.isAn.Array(_6)){this.$579[0]=_6;_6=this.$579}
for(var i=0;i<_6.length;i++){var _8=this.getHilite(_6[i])
if(_8!=null){_3=_3?_3+isc.semi+_8.cssText:_8.cssText}}
return _3}
,isc.A.editHilites=function(){if(this.hiliteWindow){this.hiliteWindow.show();return}
var _1=this.hiliteWindow=isc.Window.create({autoDraw:true,items:[isc.HiliteEditor.create({dataSource:this.dataSource,grid:this})],autoSize:true,autoCenter:true,isModal:true,showModalMask:true,closeClick:function(){this.hide()},title:"Edit Highlights",bodyProperties:{layoutMargin:8,membersMargin:8}})}
...
);isc.evalBoundary;isc.B.push(isc.A.$32t=function(){if(!this.modalEditing){if(this.canHover)this.stopHover();return}
...
if(this.isDrawn()&&this.body){this.hideInlineEditor(true);if(_10)this.body.markForRedraw("clearing extra edit row");else{for(var i=0;i<_11.length;i++){this.refreshCell(_12,_11[i])}}}}
);isc.evalBoundary;isc.B.push(isc.A.isNewEditRecord=function(_1){var _2=this.getEditSession(_1);return _2&&_2.$33i}
...
,isc.A.removeRecord=function(_1,_2){if(_2==null)_2=this.data.get(_1);if(_2==null)return;var _3=this.animateRemoveRecord&&this.isDrawn()&&this.isVisible()&&this.body&&_1>=this.body.$252&&_1<=this.body.$253;if(_3){this.$50w=true;this.body.$28b(false,_1,_1+1)}
var _4=this.getDataSource();if(_4){if(!_4.getPrimaryKeyField){this.logWarn("DataSource:"+_4+" has no primary key field - unable to remove records");return}
var _5;if(_3){_5=this.getID()+".removeDataComplete("+_1+", data,dsResponse);"}
this.removeData(_2,_5,{showPrompt:false})}else{if(isc.isAn.Array(this.data)){if(!this.data.contains(_2))return;this.data.remove(_2);if(_3)this.removeDataComplete(_1,_2)}}}
...
this.markForRedraw()}else{this.startRowAnimation(false,_1,_1+1,{target:this,methodName:"redraw"},this.animateRemoveSpeed,this.animateRemoveTime)}}
...
);isc.evalBoundary;isc.B.push(isc.A.rebuildForFreeze=function(_1){if(!this.body)return;if(this.filterEditor){this.filterEditor.deriveVisibleFields();this.filterEditor.updateBody(_1);this.filterEditor.remapEditFieldsForFreeze();this.filterEditor.layoutChildren(this.$60m)}
...
_4.src=this.buttonProperties.frozenSrc;var _4=this.Super("makeButton",arguments);var _5;if(_4.headerBaseStyle){_4.baseStyle=_4.headerBaseStyle;_5=true}else if(!_5){if(_4.frozen&&this.buttonProperties.frozenBaseStyle)
...
return _4},buttonProperties:this.getHeaderButtonProperties(),border:this.headerBorder,styleName:this.headerBarStyle,backgroundColor:this.headerBackgroundColor,backgroundImage:this.headerBackgroundImage,tabIndex:(this.canTabToHeader?this.getTabIndex():-1),canResizeItems:this.canResizeFields,canReorderItems:this.canReorderFields,dontObserve:false,childVisibilityChanged:function(){this.Super("childVisibilityChanged",arguments);this.$55g()},$3j:function(){this.Super("$3j",arguments);this.$55g()},spannedFields:Array.create({sortUnique:true}),addSpan:function(_12,_17){if(!this.$55h)this.$55h=[];this.$55h.add(_12);this.spannedFields.addList(_17);if(this.isDrawn()){this.$55i(_12);this.addChild(_12)}},$55g:function(){if(!this.$55h||!this.isDrawn())return;for(var i=0;i<this.$55h.length;i++)this.$55i(this.$55h[i])},$55i:function(_12){if(!this.isDrawn()){return}
if(_12.$55j){_12.setHeight(Math.floor(this.getVisibleHeight()/2))}
var _7=this.members.findAll("name",_12.$55k);if(!_7){_12.hide();return}
var _8,_9=0;for(var i=0;i<_7.length;i++){var _10=_7[i];_10.canReorder=false;_10.layoutAlign="bottom";if(_10.visibility!=isc.Canvas.HIDDEN){_9+=_10.getVisibleWidth();if(!_8||this.isRTL())_8=_10}}
if(_8){_12.show();_12.setLeft(_8.getLeft());_12.setWidth(_9)}},$58r:function(){if(!this.$55h)return;this.$55g();var _11=this.getVisibleHeight();for(var i=0;i<this.$55h.length;i++){var _12=this.$55h[i];this.addChild(_12);var _7=this.members.findAll("name",_12.$55k);if(!_7)continue;for(var j=0;j<_7.length;j++){var _14=_7[j],_15=_14.getVisibleHeight(),_16=_12.getVisibleHeight();if(_16+_15>_11)_14.setHeight(_15-_16)}
_12.bringToFront()}},addButtons:function(_17,_18){this.Super("addButtons",arguments);if(_2.headerSpans)_2.$60x(_17,this);this.$58r()},draw:function(){if(this.$55h&&_2.unspannedHeaderVAlign){for(var i=0;i<this.buttons.length;i++){var _4=this.buttons[i];if(!this.spannedFields.contains(_4.name))_4.valign=_2.unspannedHeaderVAlign}}
this.Super("draw",arguments);this.$58r()}},_1);if(this.headerButtonConstructor!=null)
_3.buttonConstructor=this.headerButtonConstructor;var _14=this.createAutoChild("header",_3,isc.Toolbar);if(_14.canReorderItems&&!_14.dontObserve){this.observe(_14,"itemDragReordered","observer.headerDragReordered(itemNum,newPosition,this)")}
if(_14.canResizeItems&&!_14.dontObserve)this.$62l(_14);if(this.headerSpans)this.$60x(_1.buttons,_14);return _14}
...
for(var i=0;i<_3.length;i++){var _6=_3[i];var _7=this;var _8=isc.addProperties(this.getButtonProperties(),{_constructor:_2.buttonConstructor,height:this.headerSpanHeight,align:"center",valign:this.headerSpanVAlign,showRollOver:false,showContextMenu:function(){return _7.headerSpanContextClick(this)}},_6);var _9=_6.liveObject=this.createAutoChild("headerSpan",_8);_9.$55j=true;if(this.headerSpanHeight==null){[this.headerSpanDefaults,this.headerSpanProperties,_6].map(function(_10){if(_10&&_10.height!=null)_9.$55j=false})}
...
,isc.A.headerClick=function(_1,_2){var _3=_2.getMember(_1).masterIndex,_4=this.fields[_3];if(this.canSort==false||!_4||_4.canSort==false)return false;if(_3==this.$60z()){var _5=_4.sortDirection==null?this.sortDirection:_4.sortDirection;this.sort(_3,!Array.shouldSortAscending(_5))}else{this.sort(_3)}
return false}
...
,isc.A.reorderFields=function(_1,_2,_3,_4){var _5=this.fields[_1],_6=this.fields[_2-1],_7=_1+_3,_8=this.fields[_7];var _9=this.$60z(),_10=this.fields[_9];if(!_4)this.$26a.slideRange(_1,_2,_1+_3);if(this.completeFields.contains(_8)){var _11=this.completeFields.indexOf(_5),_12=this.completeFields.indexOf(_6)+1,_13=this.completeFields.indexOf(_8);this.completeFields.slideRange(_11,_12,_13)}
this.deriveVisibleFields()
if(_9!=null){_9=this.fields.indexOf(_10);if(_9==-1)_9=null;this.$600(_9)}
var _14;if(!this.frozenFields){_14=this.getFieldHeader(_1);if(_14){_14.reorderItems(this.getLocalFieldNum(_1),this.getLocalFieldNum(_2),this.getLocalFieldNum(_1+_3))}}else{this.rebuildForFreeze();_14=this.getFieldHeader(_1)}
if(_9!=null&&_14)
_14.selectButton(this.getLocalFieldNum(_9));var _15=this.$30a;if(_15){var _16=this.$286,_17=this.getEditRow(),_18=this.getEditField(),_19=[]
...
if(this.showFilterEditor){this.filterEditor.reorderFields(_1,_2,_3,true)}
...
,isc.A.displayHeaderContextMenu=function(_1,_2){if(!_1)return;var _3=this.getHeaderContextMenuItems(_1.masterIndex);if(_3.length==0)return;if(!this.$314)this.$314=this.getHeaderContextMenu(_1);this.$314.setData(_3);if(_2!=null&&_2.length>0){this.$314.moveTo(_2[0],_2[1]);this.$314.show();return false}else{return this.$314.showContextMenu(_1)}}
...
_3.rebuildForFreeze()}})}
return _2}
,isc.A.shouldShowColumnPicker=function(_1){if(_1.treeField)return false;var _2=this.getSummaryTitle(_1);if(_2==null||isc.isAn.emptyString(_2))return false;if(_1.canHide===false)return false;return true}
,isc.A.getColumnPickerItems=function(){var _1=[],_2=this;for(var i=0;i<this.completeFields.length;i++){var _4=this.completeFields[i];if(!this.shouldShowColumnPicker(_4))continue;var _5=this.getSummaryTitle(_4);var _6=this.spanMap?this.spanMap[_4.name]:null;if(this.showTreeColumnPicker&&_6){if(!_1.find("spanConfig",_6)){_1.add({title:_6.title,autoDismiss:false,spanConfig:_6,click:function(_15,_9,_16){var _7=this.spanConfig.fields;var _8=this.anySpannedFieldsVisible();_7.map(function(_17){_8?_2.hideField(_17):_2.showField(_17)});_16.body.delayCall("markForRedraw")},anySpannedFieldsVisible:function(){var _7=this.spanConfig.fields;for(var i=0;i<_7.length;i++){if(_2.fieldIsVisible(_7[i]))return true}
return false},enableIf:function(_15,_16,_9){var _6=this.spanConfig;for(var i=0;i<_16.data.length;i++){var _9=_16.data[i];if(_2.fieldIsVisible(_9.fieldName)&&!_6.fields.contains(_9.fieldName))return true}
return false},checkIf:function(_15,_16,_9){return this.anySpannedFieldsVisible()}})}
_5="&nbsp;&nbsp;&nbsp;&nbsp;"+_5}
_1.add({title:_5,fieldName:_4.name,prompt:_4.prompt,autoDismiss:false,checkIf:function(_15,_16,_9){return _2.fieldIsVisible(this.fieldName)},enableIf:function(_15,_16,_9){return!(_2.fields.length==1&&_2.fieldIsVisible(this.fieldName))},click:function(_15,_9,_16){var _10=_16.$35q,_11=_10?_10.data.findIndex("groupItem",true):null,_12=_10?_10.data[_11]:null,_13=(_12&&_12.fieldName==_9.fieldName);if(_2.fieldIsVisible(this.fieldName)){if(_2.fields.length>1){_2.hideField(_9.fieldName)}
if(_2.fields.length==1){var _14=_16.data.find("fieldName",_2.fields[0].name);_16.setItemEnabled(_14,false);this.$58s=_14}}else{_2.showField(_9.fieldName);if(this.$58s){_16.setItemEnabled(this.$58s,true);this.$58s=null}}
if(_13){_10.setItemEnabled(_11,_2.$58f(_12.fieldName))}
_16.body.delayCall("markForRedraw")}})}
return _1}
,isc.A.getColumnPickerMenu=function(_1){var _2={canHover:true,showHover:true,cellHoverHTML:function(_3){return _3.prompt},items:_1};return{title:this.fieldVisibilitySubmenuTitle,submenu:_2,icon:"[SKINIMG]actions/column_preferences.png"}}
...
,isc.A.unsort=function(){if(this.data.unsort&&this.data.unsort()){var _1=this.$60z();this.$60z(null);if(_1!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_1);var _2=this.header.getButton(_1);if(_2)_2.setTitle(this.getHeaderButtonTitle(_2))}
...
);isc.evalBoundary;isc.B.push(isc.A.$60z=function(){if(this.sortFieldNum!=null)return this.sortFieldNum;if(this.sortField!=null){var _1=this.getFieldNum(this.sortField);if(_1==-1)_1=null;this.sortFieldNum=_1;var _2=this.getFieldName(this.sortField);this.sortField=_2;return _1}
return null}
...
_1.keyTitle=_3}
);isc.B._maxIndex=isc.C+65;isc.A=isc.Menu;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.hideAllMenus=function(){if(isc.Menu.$kc.length>0){var _1=isc.Menu.$kc,_2=false,_3,_4=isc.EH.getFocusCanvas();for(var i=_1.length-1;i>=0;i--){var _6=_1[i];if(!_6.isVisible()){continue}
...
,isc.A.computeTileDimensions=function(_1){if(((this.tileHeight&&this.tileWidth)||(this.tileSize))&&!_1)return;if(!((isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.data.resultSize>=this.data.getLength())||isc.isAn.Array(this.data)))return;if(this.layoutPolicy!="fit")return;var _2=0,_3=0;for(var i=0;i<this.data.getLength();i++){var t=this.getTile(i);var _6=t.getVisibleHeight();var _7=t.getVisibleWidth();if(_6>_2)_2=_6;if(_7>_3)_3=_7}
if(!this.tileHeight&&_2>0)this.tileHeight=_2;if(!this.tileWidth&&_3>0)this.tileWidth=_3}
...
,isc.A.getTileRecord=function(_1){var _2=this;var _3=_2.data;var _4,_5;if(this.showAllRecords){_4=0;_5=_3.getLength()}else{_4=_2.getDrawnStartIndex();_5=_2.getDrawnEndIndex()+1;if(_5>_3.getLength())_5=_3.getLength()}
...
this.layoutTiles()}else if(_1=="update"){this.logDebug("update","TileGrid");this.layoutTiles()}else if(this.data.getLength()>=this.$257){this.logDebug("filter or sort, new data same or longer","TileGrid");if(this.$257>0)this.$582();else this.layoutTiles()}else{this.logDebug("filter or sort, new data shorter","TileGrid");this.selection.deselectAll();if(this.recycleTiles&&!this.showAllRecords){var _6=this.data.getLength();if(_6<this.getDrawnEndIndex()-this.getDrawnStartIndex()+1){this.cleanupExtraTiles(_6)}}else{var _6=this.data.getLength();this.cleanupExtraTiles(_6)}
var _7=this.getDrawnEndIndex()+1;var _8=_7>this.data.getLength()?this.data.getLength():_7;var _9=this.getTilesPerLine();if(Math.floor(_7/ _9)>Math.floor(_8/ _9)&&this.getScrollTop()!=0&&this.recycleTiles){this.scrollToTop();this.layoutTiles()}else{this.$582()}}
...
,isc.A.cleanupExtraTiles=function(_1){var _2=this.tiles;for(var i=_1;i<_2.length;i++){_2[i].hide();_2[i].moveTo(0,0)}}
...
,isc.A.layoutTiles=function(){this.invokeSuper(isc.TileGrid,"layoutTiles");var _1=this.tiles?this.tiles.length:0;var _2=this.$608;if(!this.$35v&&this.recycleTiles&&_2<_1)this.cleanupExtraTiles(_2)}
