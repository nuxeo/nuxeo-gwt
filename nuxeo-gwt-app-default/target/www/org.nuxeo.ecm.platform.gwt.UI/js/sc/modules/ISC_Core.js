...
);isc.B._maxIndex=isc.C+26;Date.prototype.toBrowserString=Date.prototype.toString;Date.prototype.toBrowserLocaleString=Date.prototype.toLocaleString;if(!Date.prototype.formatter)Date.prototype.formatter="toLocaleString"
...
var _5=_2.showSeconds,_6=_2.padded,_7=_2.show24;var _8=_1.getUTCHours();_8-=isc.Time.UTCHoursOffset;var _9=_1.getUTCMinutes(),_10=_5?_1.getUTCSeconds():null,_11=_7?null:(_8>=12);if(!_7){if(_8>12)_8=_8-12;if(_8==0)_8=12}
...
_2.nativeTarget=_1.target;_2.$j5=null;_2.target=this.getEventTargetCanvas(_1,_2.nativeTarget);_2.screenX=_1.screenX;_2.screenY=_1.screenY;if(_2.eventType==this.MOUSE_WHEEL){if(isc.Canvas.useNativeWheelDelta&&_1.detail==_1.SCROLL_PAGE_UP){_2.wheelDelta=-Math.floor(_2.target.height/ isc.Canvas.scrollWheelDelta)}else if(isc.Canvas.useNativeWheelDelta&&_1.detail==_1.SCROLL_PAGE_DOWN){_2.wheelDelta=Math.floor(_2.target.height/ isc.Canvas.scrollWheelDelta)}else{var _4=_1.detail/ 3;if(!isc.isA.Number(_4))_4=0;if(_4>15||_4<-15)_4=(_4>0?1:-1);_2.wheelDelta=_4}}else{_2.wheelDelta=null}
...
);isc.evalBoundary;isc.B.push(isc.A.isKeyEvent=function(_1){_1=_1||this.lastEvent.eventType;if(this.$mh==null){this.$mh={};var _2=this.$mh;_2[this.KEY_DOWN]=true;_2[this.KEY_PRESS]=true;_2[this.KEY_UP]=true;var _3=this.$i7;for(var _4 in _3)_2[_4]=true}
...
,isc.A.getPrintHTML=function(_1,_2,_3,_4,_5){if(!isc.isAn.Array(_1))_1=[_1];if(_4==null)_4=[];if(_5==null)_5=0;var _6,_7={target:this,methodName:"gotComponentPrintHTML",components:_1,printProperties:_2,callback:_3,HTML:_4,index:_5};for(;_5<_1.length;_5++){_7.index+=1;var _8=_1[_5];var _9;if(isc.isA.String(_8))_9=_8;else _9=_8.getPrintHTML(_2,_7);if(_9!=null){_4.add(_9)}else{_6=true;break}}
if(_6){if(!_3){this.logWarn("getPrintHTML(): HTML generated asynchronously, but no callback passed in")}
return null}
if(_3){this.fireCallback(_3,"HTML,callback",[_4.join(isc.emptyString),_3])}
return _4.join(isc.emptyString)}
,isc.A.gotComponentPrintHTML=function(_1,_2){_2.HTML.add(_1);this.getPrintHTML(_2.components,_2.printProperties,_2.callback,_2.HTML,_2.index)}
...
,isc.A.showPrintPreview=function(_1,_2,_3,_4){if(!isc.PrintWindow){isc.definePrintWindow()}
...
this.$57i.showPrintPreview(_1,_2,_4)}
...
if(_5){var _9=isc.rpc.startQueue();for(var i=0;i<_1.length;i++){if(_1[i].$52e)continue;var _8=isc.clone(_1[i]);isc.addProperties(_8,this.getDropValues(_8,_6,_2,_3,_4));if(_5!=_6){if(this.dragRecategorize){var _10=_5.getForeignKeysByRelation(_8,_6);var _11=false,_12=_6.getPrimaryKeyFields();var _13;for(var _14 in _12){if(_10[_14]!==_13){this.logWarn("ListGrid dragRecategorize: source has dataSource:"+_6.getID()+". foreignKey relationship with "+"target dataSource "+_5.getID()+" is based on primary key which cannot be modified.");_11=true}}
if(!_11){isc.addProperties(_8,_10)}}
if(_5.titleField&&_6.titleField&&_5.titleField!=_6.titleField){var _13;if(_8[_5.titleField]===_13){_8[_5.titleField]=_8[_6.titleField]}}}
...
if(_3!=null)this.originalData.addListAt(_1,_3);else this.originalData.addList(_1)}else{for(var i=0;i<_1.length;i++){if(_3!=null)this.$61d(_1[i],null,null,_3);else this.$61d(_1[i])}}}}}
...
return this.Super("getChildLocator",arguments)},getInnerElementFromSplitLocator:function(_53){if(!_53||_53.length==0)return this.getHandle();var _30=_53[0],_31=_30.contains("name="),_10=_30.match("item\\["+(_31?"name='":"index='")+"(.+)'\\]\\[Class=\"(.+)\"\\]");if(_10){var _32=_10[1],_33=_10[2];var _22=this.getItem(_32);if(!_22){this.logWarn("AutoTest.getElement(): Unable to find item with identifier"+_32+", from locator:"+_30);return this.getHandle()}
...
return this.getHandle()}});isc.FormItem.addProperties({getInnerElementFromSplitLocator:function(_53){if(_53&&_53.length==1){var _14=_53[0];if(_14=="element")return this.getDataElement();if(_14=="title")return this.form.getTitleCell(this);if(_14=="textbox")return this.$15h();if(_14=="controltable")return this.$56a();var _34=_14.match("\\[icon='(.+)'\\]"),_35=_14?_14[1]:null;if(_35){return this.$16v(_35)}}}})}
