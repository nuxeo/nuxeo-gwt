...
var _10={actionURL:_6,httpMethod:_1.httpMethod||"POST"};if(_7=="postMessage"){_10.data=(_1.data||"").toString()}
...
return _4}
);isc.evalBoundary;isc.B.push(isc.A.getPrimaryKeyFields=function(){if(!this.mergedPrimaryKeys){this.mergedPrimaryKeys={};if(this.hasSuperDS()){isc.addProperties(this.mergedPrimaryKeys,this.superDS().getPrimaryKeyFields())}
...
var _4;if(_3)_4=_3.textMatchStyle;if(!this.supportsTextMatchStyle(_4)){this.logWarn("Text match style specified as '"+_4+"': This is not supported for"+" this dataSource - performing a substring match instead");_4=this.getTextMatchStyle(_4)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+124;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addSearchOperator=function(_1){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
);isc.B._maxIndex=isc.C+2;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addSearchOperator=function(_1,_2){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
,isc.A.updateCacheData=function(_1,_2){if(!isc.isAn.Array(_1))_1=[_1];var _3=this.allRows!=null,_4=_3?this.allRows:this.localData,_5=0,_6=0,_7=0;var _8=this.getDataSource().getPrimaryKeyFields();for(var i=0;i<_1.length;i++){var _10=_1[i],_11=isc.applyMask(_10,_8);var _12=this.getDataSource().findByKeys(_11,_4),_13,_14;if(_12==-1){var _15=_2.data;if(isc.isAn.Array(_15))_15=_15[0];_15=isc.applyMask(_15,_8);var _16=this.getDataSource().findByKeys(_15,_4);if(_16!=-1){this.logWarn("Update operation - submitted record with primary key value[s]:"+this.echo(_15)+" returned with modified primary key:"+this.echo(_11)+". This may indicate bad server logic. Updating cache to reflect new primary key.");_6++;_4.removeAt(_16);delete this.$573}}else if(_1.length==1){_14=_4.get(_12);if(_3&&!this.getDataSource().recordMatchesFilter(_14,this.criteria,this.context))
{_14=null}
this.$574=_14;if(_14)this.$575=this.indexOf(_14)}
var _17=_3?this.allRowsCriteria:this.criteria,_18=this.getDataSource().recordMatchesFilter(_10,_17,this.context),_19=this.shouldNeverDropUpdatedRows();if(_12==-1&&_18){this.logInfo("updated row returned by server doesn't match any cached row, "+" adding as new row.  Primary key values: "+this.echo(_11)+", complete row: "+this.echo(_10));_7++;_4.add(_10);if(_1.length==1){this.$576=_10;this.$575=_4.length-1}}else if(_12!=-1){if(_18||_19){_5++;_4.set(_12,_10)}else{if(this.logIsDebugEnabled()){this.logDebug("row dropped:\n"+this.echo(_10)+"\ndidn't match filter: "+this.echo(_17))}
...
,isc.A.transformResponse=function(_1,_2,_3){if(!_3||!_3.selectString)return;_1.status=_3.selectString("//status");if(isc.isA.String(_1.status)){var _4=isc.DSResponse[_1.status];if(_1.status==null){this.logWarn("Unable to map response code: "+_4+" to a DSResponse code, setting status to DSResponse.STATUS_FAILURE.");_4=isc.DSResponse.STATUS_FAILURE}else{_1.status=_4}}
