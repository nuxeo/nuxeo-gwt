...
//
// @param request (rpcRequest) rpcRequest to be routed through the HttpProxy
...
// ---------------------------------------------------------------------------------------
    ...
    sendRequest : function (request) {
        ...
        this.checkTransportAvailable(request);
    ...
    checkTransportAvailable : function (request) {
    
        var xmlHttpRequestAvailable = this.xmlHttpRequestAvailable();
        
        var explicitTransport = request.transport;
        if (!xmlHttpRequestAvailable) {
            if (explicitTransport == "xmlHttpRequest") {
                this.logWarn("RPC/DS request specifically requesting the xmlHttpRequest transport, but"
                                    +" xmlHttpRequest not currently available - switching transport to hiddenFrame.");
            } else if (this.defaultTransport == "xmlHttpRequest") {
    ...
    canQueueRequest : function (request) {
