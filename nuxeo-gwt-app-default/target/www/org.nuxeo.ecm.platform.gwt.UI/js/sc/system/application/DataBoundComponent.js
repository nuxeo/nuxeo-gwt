            ...
            if (dataSource) {
                ...
                for (var i = 0; i < dropRecords.length; i++) {
                    ...
                    if (dataSource != sourceDS) {
                        ...
                        if (dataSource.titleField && sourceDS.titleField && 
                ...
                if (this.isGrouped) {
                    ...
                    for (var i = 0; i < dropRecords.length; i++) {
                        if (index != null) this._addIfNotDuplicate(dropRecords[i], null, null, index);
                        else this._addIfNotDuplicate(dropRecords[i]);
                    }  
                }
