...
//<
    showPrintPreview : function (components, printProperties, previewProperties, callback) {
        ...
        this._previewWindow.showPrintPreview(components, printProperties, callback);
    }
    
});

// separate the definition of the PrintWindow class into a separate function to be fired lazily
// when the PrintWindow is required. We have to do this as the Window class is loaded after
// the PrintCanvas module
...
isc.PrintWindow.addProperties({
    ...
    showPrintPreview : function (components, printProperties, callback) {
