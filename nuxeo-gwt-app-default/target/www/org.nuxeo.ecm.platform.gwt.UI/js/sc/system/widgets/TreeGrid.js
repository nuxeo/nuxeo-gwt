...
isc.TreeGrid.addProperties({
    ...
    // If +link{treeGrid.showOpenIcons} is true, this suffix will be appended to the
    // +link{treeGrid.folderIcon} for open folders in this treeGrid.
    // @group treeIcons
    // @visibility external
    //<
    openIconSuffix:"open",
    ...
    // This suffix will be appended to the +link{treeGrid.folderIcon} for closed folders.
    // If +link{treeGrid.showOpenIcons} is set to <code>false</code> this suffix will also be
    ...
    // The filename of the default icon for all leaf nodes in this treeGrid. To specify a 
    // custom image for an individual node, set the +link{TreeGrid.customIconProperty} directly on
    // the node.
    // @group treeIcons
    //      @visibility external
    // @example nodeTitles
    ...
    // This is achieved by appending the +link{treeGrid.openIconSuffix} onto the 
    // +link{TreeGrid.folderIcon} URL [for example <code>"[SKIN]/folder.gif"</code> might be 
    ...
    // determined by +link{treeGrid.folderIcon} plus the +link{treeGrid.closedIconSuffix}.
    // @group treeIcons
    // @visibility external
    // @example nodeTitles
    //<
    ...
    // it will be shown instead of the standard +link{treeGrid.nodeIcon} for this row.<br>
    ...
    // If true, the +link{treeGrid.openIconSuffix} will be appended to the image URL
    // (so <code>"customFolder.gif"</code> might be replaced with 
    // <code>"customFolder_open.gif"</code>).<br>
    // <b>Note</b> that we never append the +link{treeGrid.closedIconSuffix} to custom folder icons.<br>
    // Can be overridden at the node level via the +link{treeGrid.customIconOpenProperty} property.
    // @group treeIcons
    // @visibility external
    //<
...
// <P>
// By default icons are derived from +link{TreeGrid.folderIcon} and +link{TreeGrid.nodeIcon}.
// Custom icons for for individual nodes can be overriden by setting the +link{TreeGrid.customIconProperty}
// on a node.
// <p>
...
getPrintHTML : function (printProperties, callback) {
    ...
    if (expand == null) expand = printProperties.expandTrees;
