...
_showEmptyMessage : function () {
    return this.getEmptyMessageHTML();
},
...
//<
getEmptyMessageHTML : function () {
    if (!this.showEmptyMessage)	return "&nbsp;";
    if (this.isPrinting) { 
        return "<span class='" + this.emptyMessageTableStyle + "'>" + 
                this.getEmptyMessage() + "</span>";
    }
...
getCellStyleIndex : function (record, rowNum, colNum) {
    ...
    // Not disabled - check for selected and/or over
        ...
        if (this.selectionEnabled() && !this.isPrinting) {
