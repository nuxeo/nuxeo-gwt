...
computeTileDimensions : function (forceCompute) {
    ...
    if (!((isc.ResultSet && isc.isA.ResultSet(this.data) && this.data.resultSize >= this.data.getLength())
        || isc.isAn.Array(this.data))) return;  
...
layoutTiles : function () {   
    ...
    if (!this._animating && this.recycleTiles && visLen < tilesLen) this.cleanupExtraTiles(visLen);
