...
//>	@method	menu.getItem()
//		Get a particular item by number or by reference 
//			(allows most routines to take either an actual item or an item number)
//		@group	menuItems
//		@param	item		(number | object )	number of the item or pointer to the object
//		@return	(object)	Pointer to the item, or null if not defined
//<
...
//		Given an item, return the item number associated with it.
//		@group	menuItems
//		@param	item		(number | object )	Number of the item or pointer to the object
//		@return	(object)	Number to the item, or -1 if not defined.
//<
