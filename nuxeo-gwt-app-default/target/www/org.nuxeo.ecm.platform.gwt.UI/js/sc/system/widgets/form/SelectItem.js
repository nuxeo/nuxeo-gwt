...
isc._SelectItemProperties = {
    ...
    //>	@attr	selectOtherItem.separatorValue		(string : "----" : IRW)
	//			value for the separator between normal items and the Other... value
	//		@group	appearance
	//<
	separatorValue:"----",

    //>	@attr	selectOtherItem.separatorTitle		(string : "--------------------" : IRW)
	//			title for the separator between normal items and the Other... value
	//		@group	appearance
    // @visibility external
	//<
	separatorTitle:"--------------------",

    //>	@attr	selectOtherItem.otherValue		(string : "***other***" : IRW)
	//			value for the Other... item
	//		@group	appearance
	//<
	otherValue:"***other***",
