...
//    wrapTitle:null,
    ...
    //>	@attr	formItem.hint		(string : null : IRWA)
...
isc.FormItem.addMethods({
    ...
    _getTableHTML : function (value, includeHint, includeErrors) {
        ...
        if (writeOuterTable) {
            ...
            if (includeHint || showRightError) {
                var hint = this.getHint();
                if (showErrors || (hint && !isc.isA.emptyString(hint))) {
	...
	getErrorHTML : function (error) {
		...
		var form = this.form,
            ...
            if (!writeTable) {
    			output = isc.SB.concat("<DIV CLASS='" , this.getCellStyle() , "'>" 
        ...
        // We embed the icon in a link to make it focusable
            ...
            if (isc.FormItem._iconTemplate == null) {
                isc.FormItem._iconTemplate = [
                    ...
                    " style='display:block;margin-left:",     // 3     
