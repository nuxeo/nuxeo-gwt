...
// If false, the ColorPicker is centred
// @visibility external
//<     
autoPosition: true,
...
// This is a public hook; it is intended that client code observes or overrides this 
// method if it needs to be kept informed of changes in the component in real-time 
// (for example, if it needs to update its own GUI accordingly), and then uses the 
// getXxxx() methods to obtain current state, as required. It is not intended that
// client code call this method.
...
//
// I'm not documenting these for now - probably don't have much general-purpose 
// usefulness
