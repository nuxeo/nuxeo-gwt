...
getTilesPerLine : function () {
    if (this.tilesPerLine) return this.tilesPerLine;
        ...
        if ( tMargin * (numTiles - 1) + (numTiles * tSize) + marginOffset > thisSize) numTiles--;
...
_animateChange : function () {
    ...
    // visible before and are still visible now) by calling our override of processTile(), and 
