...
//    wrapItemTitles:null,
    ...
    //> @attr dynamicForm.showErrorText (boolean : true : IRW)
    ...
    //> @attr dynamicForm.errorOrientation (align : null : IRW)
...
//
//		@return	(object)	FormItem object or null if not found	
//<
...
getInnerHTML : function () {
    ...
    for (var colNum = 0; colNum < colWidths.length; colNum++) {
        ...
        output.append(this._$topRowCellStart, 
