...
// <p>
// In this case the root node must be supplied separately via +link{Tree.root}, or you may instead provide
// the <code>id</code> of the root node via +link{Tree.rootValue}.  So for example, to create
// this tree:
// <pre>
// foo
//   bar
...
// properties for "color" and "shape"; <code>tree.find({color: "green", shape: "circle"}) would 
// return the first node in the tree where both properties matched.
// <br><br>
