...
//			 can be simply eval'd to rebuild the original object.<br><br>
//
...
//		@param	[name]		(string)	global name for the object.  Used for serializing object references.
...
//<
serialize : function (object, indent, removeFields, keepFields) {
	return isc.Comm._serialize(object, indent ? "" : null, removeFields, keepFields);
},
...
//<
_serialize : function (object, prefix, context, removeFields, keepFields) {
	if (!context) {
		context = {};
	...
	return isc.Comm._serializeObject((object.getSerializeableFields ? 
									  object.getSerializeableFields(removeFields, keepFields) :	object), 
									 context.objPath, context.objRefs, prefix);
},
