...
isc.Class.addMethods({
	...
	serialize : function (indent, removeFields, keepFields) {
		return isc.Comm.serialize(this, indent, null, removeFields, keepFields);
	},

	xmlSerialize : function (indent, removeFields, keepFields) {
		return isc.Comm.xmlSerialize(this.getClassName(), this, indent, null,      
