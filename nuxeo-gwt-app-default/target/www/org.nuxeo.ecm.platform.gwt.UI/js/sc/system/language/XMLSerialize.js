...
//<
xmlSerialize : function (name, object, indent, removeFields, keepFields) {
	return isc.Comm._xmlSerialize(name, object, indent ? "" : null, removeFields, keepFields);
},
...
//<
_xmlSerialize : function (name, object, prefix, context, removeFields, keepFields) {
	...
	// and return anything else as a simple object - if the object has a getSerializeableFields
	// method on it - use that otherwise just use the object
    var serializeableFields = object.getSerializeableFields ? 
        object.getSerializeableFields(removeFields, keepFields) : object;

	return isc.Comm._xmlSerializeObject(name, serializeableFields, context.objPath, 
                                        context.objRefs, prefix, isRoot);
},
